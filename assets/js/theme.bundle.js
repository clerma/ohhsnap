   ...
   var e, t = {
		 ...
		 801: (e, t, o) => {
			...
			c().init({
			   ...
			   once: !0,
			   startEvent: "load"
			}), window.AOS = c(), window.Alert = a.bZ, window.Button = a.zx, window.Carousel = a.lr, window.Collapse = a.UO, window.Dropdown = a.Lt, window.Modal = a.u_, window.Offcanvas = a.TB, window.Popover = a.J2, window.ScrollSpy = a.DA, window.Tab = a.OK, window.Toast = a.FN, window.Tooltip = a.u;
			var d = o(765),
			   i = o.n(d);
