(() => {
   var e, t = {
               ...
               t.forEach((t => {
                  window.addEventListener(t, (() => {
                     const t = window.pageYOffset,
                        a = o < t && t > 0 ? "-100%" : "0";
                     e.querySelector(".navbar-collapse").classList.contains("show") || (e.style.transform = `translateY(${a})`), o = t
                  }))
               }))
            }))
         },
         5976: () => {
            ...
            function a(e) {
               e.classList.remove("navbar-dark"), e.classList.add("navbar-light"),
                  function(e) {
                     e.style.boxShadow = "inset 100% 100% 100% white"
                  }(e)
            }
            ...
            function l(e, t, o, l, s) {
               ...
               "show.bs.collapse" === e && a(t), "hidden.bs.collapse" === e && o && r(t), "hidden.bs.collapse" === e && (!l && !o || l && !c) && n(t), "load" !== e && "scroll" !== e || !l || d || (c ? a(t) : n(t))
            }
            e.forEach((e => {
         ...
         801: (e, t, o) => {
            ...
            var a = o(6468),
               ...
               s = o(2711),
               c = o.n(s);
            // AOS: expose library, but do NOT auto-init (init is opt-in for performance)
const __AOS = c();
window.AOS = __AOS;
window.GK = window.GK || {};
window.GK.initAOS = function initAOS(options){
   if (!window.AOS || typeof window.AOS.init !== "function") return false;
   const defaults = { duration: 700, easing: "ease-out-quad", once: true, startEvent: "load" };
   try { window.AOS.init(Object.assign({}, defaults, options || {})); } catch(e) { return false; }
   return true;
};
window.GK.initAOSIfPresent = function initAOSIfPresent(options){
   if (!document.querySelector("[data-aos]")) return false;
   return window.GK.initAOS(options);
};
 window.Alert = a.bZ, window.Button = a.zx, window.Carousel = a.lr, window.Collapse = a.UO, window.Dropdown = a.Lt, window.Modal = a.u_, window.Offcanvas = a.TB, window.Popover = a.J2, window.ScrollSpy = a.DA, window.Tab = a.OK, window.Toast = a.FN, window.Tooltip = a.u;
            var d = o(765),
               i = o.n(d);
            ...
            p().registerLanguage("xml", g()), p().registerLanguage("javascript", v()), y.forEach((e => {
               p().highlightBlock(e)
            })), window.hljs = p();
            var b = o(7564),
               E = o.n(b),
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  observer.observe(document.body, { childList: true, subtree: true });
            ...
            // Jarallax: expose fns, but do NOT auto-init (init is opt-in for performance)
window.jarallax = l.jarallax;
window.jarallaxElement = l.jarallaxElement;
window.jarallaxVideo = l.jarallaxVideo;

window.GK = window.GK || {};
window.GK.initJarallax = function initJarallax(options){
   if (!window.jarallax || typeof window.jarallax !== "function") return false;
   const nodes = document.querySelectorAll("[data-jarallax], [data-jarallax-element]");
   if (!nodes || !nodes.length) return false;
   try { window.jarallaxVideo && window.jarallaxVideo(); } catch(e) {}
   try { window.jarallaxElement && window.jarallaxElement(); } catch(e) {}
   try { window.jarallax(nodes, options || {}); } catch(e) { return false; }
   return true;
};
window.GK.initJarallaxIfPresent = function initJarallaxIfPresent(options){
   if (!document.querySelector("[data-jarallax], [data-jarallax-element]")) return false;
   return window.GK.initJarallax(options);
};
            ...
            function C(e, t) {
               window.innerWidth < J || (t.classList.add("showing"), setTimeout((() => {
            ...
            j.forEach((e => {
               ...
               e.addEventListener("mouseenter", (e => {
                  ...
                  ! function(e, t) {
                     window.innerWidth < J || t.classList.contains("show") && ("click" === e.type && e.target.closest(".dropdown-menu form") || (t.classList.add("showing"), t.classList.remove("show"), setTimeout((() => {
               ...
               e.addEventListener("click", (e => {
                  ! function(e, t) {
                     ...
                     t.parentElement.closest(".navbar, .navbar .dropdown-menu").querySelectorAll(".dropdown-menu").forEach((e => {
               ...
               e.addEventListener("hide.bs.collapse", (() => {
                  ! function(e) {
                     window.innerWidth >= J || e.forEach((e => {
   ...
   a.m = t, e = [], a.O = (t, o, n, r) => {
      if (!o) {
         ...
         for (i = 0; i < e.length; i++) {
            for (var [o, n, r] = e[i], s = !0, c = 0; c < o.length; c++)(!1 & r || l >= r) && Object.keys(a.O).every((e => a.O[e](o[c]))) ? o.splice(c--, 1) : (s = !1, r < l && (l = r));
            if (s) {
               e.splice(i--, 1);
               var d = n();
               void 0 !== d && (t = d)
