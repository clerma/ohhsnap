...
banner:
  ...
  subtext: Bring your event to life with our interactive virtual photo booth, allowing guests to create and share fun moments from anywhere!
            ...
            <div class="col-md-5">
                ...
                <div class="position-relative">
                    ...
                    <div class="flickity-buttons-adjacent flickity-buttons-bottom-start w-xl-125" data-flickity='{"imagesLoaded": true, "prevNextButtons": true, "pageDots": false, "wrapAround": true}'>
                        <div class="w-100">
                            <!-- Image -->
                            <img class="img-fluid" src="assets/img/virtual-booth/VirtualBoothOverlayCollage.png" alt="..." data-aos="wipe-right" data-aos-delay="100">
                        </div>
                        <div class="w-100">
                            <!-- Image -->
                            <img class="img-fluid" src="assets/img/virtual-booth/VirtualBoothPromoStill08.jpg" alt="...">
                        </div>
                        <div class="w-100">
                            <!-- Image -->
                            <img class="img-fluid" src="assets/img/virtual-booth/VirtualBoothPromoStill10.jpg" alt="...">
                        </div>
                    </div>
                </div>
            </div>
...
<section class="bg-dark mt-10">
   <div class="container-lg">
   <div class="row py-10 aos-init aos-animate" data-aos="fade-up">
     <div class="col-md-4">
       <div class="col-md-12">
         <!-- Item -->
         <div class="d-flex mt-8 mt-md-9">
           ...
           <i class="fa-duotone fa-solid fa-copyright fa-3x" aria-hidden="true"></i> </div>
           <!-- Body -->
           <div class="ms-5">
           <!-- Title -->
       ...
       <div class="col-md-12">
         ...
         <div class="d-flex mt-8 mt-md-9">
           <!-- Icon -->
           <div class="icon text-primary-light">
           <i class="fa-duotone fa-solid fa-mobile fa-3x" aria-hidden="true"></i> </div>
           <!-- Body -->
           <div class="ms-5">
           <!-- Title -->
           <p class="fs-lg fw-bold text-white mb-1">
       ...
       <div class="col-md-12">
        ...
        <div class="d-flex mt-8 mt-md-9">
          <!-- Icon -->
          <div class="icon text-primary-light">
         <i class="fa-regular fa-nfc-slash fa-3x"></i> </div>
          <!-- Body -->
          <div class="ms-5">
          <!-- Title -->
          <p class="fs-lg fw-bold text-white mb-1">
     ...
     <div class="col-md-4">
       <div class="col-md-12">
         ...
         <div class="d-flex mt-8 mt-md-9">
           <!-- Icon -->
           <div class="icon text-primary-light">
             <i class="fa-duotone fa-solid fa-eraser fa-3x"></i>
            </div>
           <!-- Body -->
           <div class="ms-5">
           <!-- Title -->
       ...
       <div class="col-md-12">
         ...
         <div class="d-flex mt-8 mt-md-9">
           <!-- Icon -->
           <div class="icon text-primary-light">
          <i class="fa-light fa-arrow-down-to-square fa-3x"></i>
         </div>
           <!-- Body -->
           <div class="ms-5">
           <!-- Title -->
       ...
       <div class="col-md-12">
        ...
        <div class="d-flex mt-8 mt-md-9">
          <!-- Icon -->
          <div class="icon text-primary-light">
          <i class="fa-duotone fa-solid fa-grid-round-2 fa-3x"></i>
        </div>
          <!-- Body -->
          <div class="ms-5">
          <!-- Title -->
...
<section class="py-9 pt-md-11 bg-white">
  <div class="container-lg">
    <div class="row justify-content-center">
      <div class="col-md-10 col-lg-8 text-center">
        ...
        How it works: Guest <span class="text-underline-warning">captures</span> and <span class="text-underline-warning">shares</span> instantly from anywhere.
        </h2>
      </div>
    </div>
    <div class="row justify-content-center">
 ...
 <section class="pt-12 py-md-10 pb-11 bg-dark" style="background-image: url(assets/img/patterns/pattern-1.svg);">
   ...
   <div class="flickity-items-fade" data-flickity='{"imagesLoaded": true, "pageDots": false, "wrapAround": true}'>
     ...
     {% if item.path contains '/assets/img/virtual-booth/gallery/' %}
